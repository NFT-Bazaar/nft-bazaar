...
function Home() {
  ...
  return (
    <main className="main bg-image fadeIn-animation overflow-x-hidden flex items-center paddong-card">
        ...
        <div className="md:row-start-1 mb-20 md:mb-0">
          <div className="content flex flex-col justify-center">
            ...
            <p className="content__second-title py-11">
              Swap or trade any NFT on any chain in the NFT Bazaar!
              Visit us today and start trading!
            </p>
            <span>
              <a
                href="../../nftbazaar"
